...
export default class ExtractorSvc {
  ...
  /////////////////////////////////////////////////////////
	download (getToken, urn, directory) {
      ...
      try {
        ...
        const manifest =
          await this.getManifest (getToken, urn)

        // harvest derivatives
        const derivatives = await this.getDerivatives (
          getToken, manifest.body || manifest)
  ...
  parseManifest (manifest) {
    ...
    parseNodeRec({
      children: manifest.derivatives || manifest.children
    })
  ...
  /////////////////////////////////////////////////////////
  // Get dmanifest for specific URN
  //
  /////////////////////////////////////////////////////////
  getManifest (getToken, urn) {

    return new Promise(async(resolve, reject) => {

      const baseUrl = 'https://developer.api.autodesk.com/'

      const url = `${baseUrl}viewingservice/v1/${urn}`
